...
def compute_metrics(p):
    """
    Metrics for binary classification (Medical / Press)
    """
    logits = p.predictions
    labels = p.label_ids

    # If model outputs shape (N, 1), squeeze it
...
print("First label:", data_test[0]["label"])
print("First input_ids length:", len(data_test[0]["input_ids"]))
